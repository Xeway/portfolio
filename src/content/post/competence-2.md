...
description: Cette section décrit mes travaux sur l'optimisation des applications, incluant l'analyse de performance et l'utilisation de bibliothèques dédiées, pour la SAÉ.
order: 2
---
